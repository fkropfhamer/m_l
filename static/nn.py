...
class NN:
    ...
    def update(self, inputs, targets, learning_rate):
        ...
        self.output_weights += learning_rate * np.dot((hidden_errors * hidden_outputs * (1.0 - hidden_outputs)), np.transpose(inputs))
    ...
    def predict(self, inputs):
        final_outputs, _, _, _  = self.calculate_inputs_and_outputs(inputs)
